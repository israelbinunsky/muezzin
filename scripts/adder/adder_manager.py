...
def add_stt():
    ...
    for doc in all_docs:
        ...
        elastic.send(doc, 'podcasts text' )

def add_analysis():
    elastic.add_mapping_field("bds_percent", "long")
    elastic.add_mapping_field("is_bds", "boolean")
    elastic.add_mapping_field("bds_threat_level", "text")
    all_docs = elastic.get_all_docs()
    for doc in all_docs:
...
# doc = all_docs[0]
# print(doc)
# analysis.update_stats(doc['_id'], text)
# doc = all_docs[0]
# print(doc)
